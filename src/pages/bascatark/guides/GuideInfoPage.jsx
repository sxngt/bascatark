...
const GuideInfoPage = () => {
	const youtubeVideoId = "6EoWJDDwFBI"; // 여기에 실제 YouTube 비디오 ID를 넣으세요
			...
			<div className="container mx-auto px-4 pt-24 pb-16">
				...
				<div className="max-w-4xl mx-auto bg-gradient-to-br from-yellow-900/20 to-yellow-800/20 p-6 rounded-lg border border-yellow-700/30">
					...
					<div className="mt-6 text-yellow-100/80">
						<h2 className="text-2xl font-bold text-yellow-500 mb-4">전시 가이드 영상</h2>
						<p className="mb-4">
							이 영상을 통해 전시 관람 방법과 주의사항을 확인하실 수 있습니다.
						</p>
